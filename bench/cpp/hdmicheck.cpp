////////////////////////////////////////////////////////////////////////////////
//
// Filename:	bench/cpp/hdmicheck.cpp
// {{{
// Project:	vgasim, a Verilator based VGA simulator demonstration
//
// Purpose:	This is a basic test bench for the HDMI source and simulator
//		together.  It doesn't use verilator, but rather proves that
//	the HDMI source can actually create a valid source for a verilator based
//	project.  To do this, the HDMISOURCE is fed directly into the HDMISIM,
...
public:
	...
	TESTBENCH(void) : m_win(640, 480), m_src(640, 480)
			// m_vga(1280, 1024)
			// m_vga(1280,720)
			{
		//
