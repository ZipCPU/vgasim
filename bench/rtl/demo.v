////////////////////////////////////////////////////////////////////////////////
//
// Filename:	bench/rtl/demo.v
// {{{
// Project:	vgasim, a Verilator based VGA simulator demonstration
//
// Purpose:	Generates a video image from a fixed memory image loaded at
//		startup.  This is the top level of a Wishbone VGA framebuffer
...
module	demo #(
		// {{{
		parameter	BW=32,
				FW=13,	// Log_2 of the maximum width or FIFO sz
	...
	memdev	#(
		// {{{
		.LGMEMSZ(AW+2),.DW(BW), .HEXFILE("slide.hex"), .OPT_ROM(1'b1)
		// }}}
	) memi(
		// {{{
		i_clk, i_reset,
	...
	////////////////////////////////////////////////////////////////////////
	//
	// Image reading and VGA video signal generation
	// {{{
	////////////////////////////////////////////////////////////////////////
	//
	//
	...
	wbvgaframe #(
		// {{{
		.ADDRESS_WIDTH(AW), .BUS_DATA_WIDTH(BW),
		.FW(FW), .LW(LW)
		// }}}
	) vgai(
		// {{{
		i_clk, i_pixclk, i_reset, 1'b1, i_test,
		0, { 1'b0, i_hm_width },
		i_hm_width, i_hm_porch, i_hm_synch, i_hm_raw,
		i_vm_height,i_vm_porch, i_vm_synch, i_vm_raw,
		//
		wb_cyc, wb_stb, wb_addr, 1'b0, mem_ack, mem_data, 1'b0,
